...
import { Bug, Calendar, User, Search, ExternalLink } from 'lucide-react';
...
export const ErrorReportsManagement: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    const variants = {
      ...
      investigating: { color: 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-400', label: 'Investigando' },
      resolved: { color: 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400', label: 'Resolvido' },
      wont_fix: { color: 'bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400', label: 'Não será corrigido' },
      duplicate: { color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400', label: 'Duplicado' }
    };
      ...
      <div className="flex gap-4">
        ...
        <Select value={statusFilter} onValueChange={setStatusFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="wont_fix">Não Corrigidos</SelectItem>
